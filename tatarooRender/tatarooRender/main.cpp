...
void test1(){
    ...
    Vec4f p1(0,0,0.1,1);
    Vec4f p2(0,0,0.9,1);
    Vec4f l1 = projection * view * model * p1;
    Vec4f l2 = projection * view * model * p2;
    Vec3f k1= m2v(l1);
    Vec3f k2= m2v(l2);
    Vec3f t1 = Vec3f((k1.x + 1) * width / 2, (k1.y + 1) * height / 2, (k1.z + 1) * 0.5);
    Vec3f t2 = Vec3f((k2.x + 1) * width / 2, (k2.y + 1) * height / 2, (k2.z + 1) * 0.5);
    int k = 0;
}
